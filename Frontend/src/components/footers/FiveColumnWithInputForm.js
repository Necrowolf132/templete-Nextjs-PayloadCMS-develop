...
import IconImages from "next/image"
...
const LogoImg = tw(IconImages)`w-8`;
        ...
        <ThreeColRow>
          ...
          <SocialLinksContainer>
            <SocialLink href="https://facebook.com">
              <IconImages src="/images/facebook-icon.svg" width="50" height="50" alt="redes"/>
            </SocialLink>
            <SocialLink href="https://twitter.com">
              <IconImages src="/images/twitter-icon.svg" width="50" height="50" alt="redes"/>
            </SocialLink>
            <SocialLink href="https://youtube.com">
              <IconImages src="/images/youtube-icon.svg" width="50" height="50" alt="redes"/>
            </SocialLink>
          </SocialLinksContainer>
        </ThreeColRow>
      </Content>
