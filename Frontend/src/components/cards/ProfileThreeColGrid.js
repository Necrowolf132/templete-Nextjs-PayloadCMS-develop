...
import  twitterIcons from "../../images/twitter-social-media-svgrepo-com.svg";
import  linkedinIcons  from "../../images/linkedin-icon.svg";
import  githubIcons from "../../images/github-icon.svg";
                ...
                <CardLinks>
                  {card.links.map((link, linkIndex) => (
                    <a key={linkIndex} className="link" href={link.url}>
                      <IconImages src={link.icon} alt="Redes"   className="icon" />
                    </a>
                  ))}
                </CardLinks>
              </CardContent>
